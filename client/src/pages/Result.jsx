...
const Result = () => {
  ...
  return (
    ...
    {!isImageLoaded && 
    <div className='flex bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full max-w-md w-full'>
    ...
    <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full'>
        <p onClick={()=>{setIsImageLoaded(false)}} className='bg-transparent border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer'>Generate Another</p>
